...
(function (global, factory) {
  ...
  exports.generateSunkenSailerSentenceTemplates = function(secretWord) {
    sentenceTemplates = [];
    shuffleArray(ogSentenceTemplates);
    ogSentenceTemplates.forEach((template) => {
      if (template.includes('{{noun}}')) {
        sentenceTemplates.push(template.replace('{{noun}}', `**${secretWord}**`));
  ...
  var makeSentenceFromTemplate = function makeSentenceFromTemplate(isSunken) {
    const template = isSunken ? sunkenSentenceTemplate : rand(sentenceTemplates);
    return make(template);
  };
  var sentence = function sentence(isSunken) {
    var phrase = randomStartingPhrase();
    var s = phrase + makeSentenceFromTemplate(isSunken);
