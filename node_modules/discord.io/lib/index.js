...
DCP.getScrubs = function(input, callback) {
	return scrubs;
}
 ...
 * Gets a channel.
 */
DCP.getChannel = function(channelID, callback) {
	//callback = console.log;
	this._req('get', Endpoints.CHANNEL(channelID), function(err, res) {
		...
		// 	}
		// }
		handleResCB('Unable to get channel for given id' + channelID, err, res, callback);
	});
};	
...
function Server(client, data) {
	...
	// const util = require('util');	
	// console.log(util.inspect(server.roles, false, null));
	...
	data.presences.forEach(function(presence) {
		...
		delete(presence.user);
		//const util = require('util');	
		//console.log(util.inspect(presence, false, null));
